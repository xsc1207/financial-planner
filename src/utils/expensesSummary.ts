import {
  ...
  export const getMonthlyFixedExpensesTotal = (
    ...
    return getActiveFixedExpenses(fixedExpenses).reduce(
  ...
  export const getMonthlyTotalExpenses = (
    ...
    const fixedTotal = getMonthlyFixedExpensesTotal(fixedExpenses);
  ...
  export const getFixedExpenseTotalByCategory = (
    ...
    return getActiveFixedExpenses(fixedExpenses)
      .filter((expense) => expense.category === category)
